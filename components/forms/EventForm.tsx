...
// marking it as a client componentn
type FormFields = {
  event?: {
    id: string;
    name: string;
...
// hanles creating, editing, and deleting an event
export default function EventForm({ event }: FormFields) {
  ...
  // useTransition react hook that manages state of transition in async operations
  //   useTransition
